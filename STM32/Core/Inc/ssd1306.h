...
/**
 * This SSD1306 OLED uses I2C for communication
 *
 ...
 * @note   @ref SSD1306_UpdateScreen() must be called after that in order to see updated OLED screen
 ...
 * @note   @ref SSD1306_UpdateScreen() must called after that in order to see updated OLED screen
